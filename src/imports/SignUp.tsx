      ...
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26.5 12">
        <g id="Battery Icon">
          <g id="Combined Shape" opacity="0.4">
            <mask fill="white" id="path-1-inside-1_1_2110">
              <path d={svgPaths.p303e8640} />
            </mask>
            <path d={svgPaths.p29c93100} fill="var(--stroke-0, black)" mask="url(#path-1-inside-1_1_2110)" />
          </g>
...
function Group6() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] h-[328.618px] inline-grid items-[start] justify-items-[start] ml-0 mt-0 relative row-1 w-[258.725px]">
...
function Frame6() {
  return (
    <div className="-translate-x-1/2 absolute content-start flex flex-wrap gap-[20px_40px] h-[628px] items-start justify-center left-[calc(50%+0.5px)] px-[140px] top-[115px] w-[485px]">
      <Frame />
      <Frame7 />
    </div>
  );
...
function Header() {
  return (
    <div className="h-[46px] relative shrink-0 w-[341px]" data-name="Header">
      <p className="absolute font-['Korto:Bold',sans-serif] inset-0 leading-[normal] not-italic text-[#555] text-[38px] text-center whitespace-pre-wrap">{`Sign Up  `}</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="bg-white content-stretch flex h-[60px] items-center px-[20px] relative rounded-[30px] shrink-0 w-[500px]">
      <div aria-hidden="true" className="absolute border border-[#555] border-solid inset-0 pointer-events-none rounded-[30px]" />
      <p className="font-['Korto:Book',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#888] text-[18px] w-[216px] whitespace-pre-wrap">John</p>
    </div>
  );
}
...
function FirstName() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="First Name">
      <p className="font-['Korto:Book',sans-serif] leading-[normal] not-italic relative shrink-0 text-[23px] text-black w-[300px] whitespace-pre-wrap">First Name</p>
      <Frame1 />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="bg-white content-stretch flex h-[60px] items-center px-[20px] relative rounded-[30px] shrink-0 w-[500px]">
      <div aria-hidden="true" className="absolute border border-[#555] border-solid inset-0 pointer-events-none rounded-[30px]" />
      <p className="font-['Korto:Book',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#888] text-[18px] w-[216px] whitespace-pre-wrap">Smith</p>
    </div>
  );
}
...
function LastName() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Last Name">
      <p className="font-['Korto:Book',sans-serif] leading-[normal] not-italic relative shrink-0 text-[23px] text-black w-[300px] whitespace-pre-wrap">Last Name</p>
      <Frame2 />
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="bg-white content-stretch flex h-[60px] items-center px-[20px] relative rounded-[30px] shrink-0 w-[500px]">
      <div aria-hidden="true" className="absolute border border-[#555] border-solid inset-0 pointer-events-none rounded-[30px]" />
      <p className="font-['Korto:Book',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#888] text-[18px] w-[216px] whitespace-pre-wrap">(123) 456 7890</p>
    </div>
  );
}
...
function PhoneNumber() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Phone Number">
      <p className="font-['Korto:Book',sans-serif] leading-[normal] not-italic relative shrink-0 text-[23px] text-black w-[300px] whitespace-pre-wrap">Phone Number</p>
      <Frame3 />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="bg-white content-stretch flex h-[60px] items-center px-[20px] relative rounded-[30px] shrink-0 w-[500px]">
      <div aria-hidden="true" className="absolute border border-[#555] border-solid inset-0 pointer-events-none rounded-[30px]" />
      <p className="font-['Korto:Book',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#888] text-[18px] w-[216px] whitespace-pre-wrap">JohnSmith@gmail.com</p>
    </div>
  );
}
...
function Email() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Email">
      <p className="font-['Korto:Book',sans-serif] leading-[normal] not-italic relative shrink-0 text-[23px] text-black w-[300px] whitespace-pre-wrap">Email</p>
      <Frame4 />
    </div>
  );
}
...
function CreateNewAccount() {
  return (
    <div className="bg-[#60b010] content-stretch flex h-[60px] items-center justify-center px-[62px] relative rounded-[30px] shrink-0 w-[600px]" data-name="Create New Account">
...
function GoBack() {
  return (
    <div className="content-stretch flex h-[48px] items-center justify-center px-[80px] py-[12px] relative rounded-[20px] shrink-0 w-[600px]" data-name="Go Back">
      <div aria-hidden="true" className="absolute border border-[#8e8e8e] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <p className="font-['Korto:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#555] text-[20px] text-center">Go Back</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[30px] h-[823px] items-center justify-end left-0 px-[16px] py-[50px] rounded-[30px] shadow-[0px_-2px_8.9px_0px_rgba(0,0,0,0.25)] top-[372px] w-[834px]">
      <Header />
      <FirstName />
      <LastName />
      <PhoneNumber />
...
export default function SignUp() {
  return (
    <div className="bg-white overflow-clip relative rounded-[25px] size-full" data-name="Sign up">
      <StatusBar />
      <div className="-translate-x-1/2 absolute left-1/2 size-[1138px] top-[372px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1138 1138">
          <circle cx="569" cy="569" fill="var(--fill-0, #D0DFF6)" id="Ellipse 766" r="569" />
        </svg>
      </div>
      <Frame6 />
      <Frame5 />
