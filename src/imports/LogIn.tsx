      ...
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26.5 12">
        <g id="Battery Icon">
          <g id="Combined Shape" opacity="0.4">
            <mask fill="white" id="path-1-inside-1_1_1970">
              <path d={svgPaths.p303e8640} />
            </mask>
            <path d={svgPaths.p29c93100} fill="var(--stroke-0, black)" mask="url(#path-1-inside-1_1_1970)" />
          </g>
...
function Header() {
  return (
    <div className="h-[46px] relative shrink-0 w-[341px]" data-name="Header">
      <p className="absolute font-['Korto:Bold',sans-serif] inset-0 leading-[normal] not-italic text-[#555] text-[38px] text-center whitespace-pre-wrap">Log In</p>
    </div>
  );
}
...
function Group12() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] leading-[0] relative shrink-0">
      <div className="col-1 h-[377px] ml-0 mt-0 relative row-1 w-[184px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 184 377">
          <path d={svgPaths.p2b23ed00} fill="var(--fill-0, #555555)" id="Rectangle 36" />
        </svg>
      </div>
      <div className="col-1 h-[97px] ml-[43px] mt-[140px] opacity-35 relative row-1 w-[96px]" data-name="image 18">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[100.45%] left-[-2.08%] max-w-none top-[-0.22%] w-[106.25%]" src={imgImage18} />
        </div>
      </div>
    </div>
  );
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0">
      <p className="font-['Korto:Book',sans-serif] leading-[normal] not-italic relative shrink-0 text-[20px] text-black text-center w-[186px] whitespace-pre-wrap">Scan QR code to login</p>
    </div>
  );
}
...
function LogIn1() {
  return (
    <div className="bg-[#cb7701] h-[60px] relative rounded-[30px] shrink-0 w-full" data-name="Log In">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[62px] relative size-full">
...
function Frame1() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[40px] h-[823px] items-center justify-end left-0 px-[16px] py-[50px] rounded-[30px] shadow-[0px_-2px_8.9px_0px_rgba(0,0,0,0.25)] top-[372px] w-[834px]">
      <Header />
      <Group12 />
      <Frame5 />
      <Frame4 />
...
export default function LogIn() {
  return (
    <div className="bg-white overflow-clip relative rounded-[20px] size-full" data-name="log in">
      <StatusBar />
